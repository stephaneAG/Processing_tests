...
void startScreenCapture(){
  ...
  //currentScreenShot.resize(0, 425); // iPhone max > laggy (else throw concurent edition error (..) )
  currentScreenShot.resize(0, 400);
  //currentScreenShot.resize(0, 350); // a little laggy but usable
  //currentScreenShot.resize(0, 200); // nearly no lag on UDP socket, but ugly as can be
  //currentScreenShot.resize(0, 100);
