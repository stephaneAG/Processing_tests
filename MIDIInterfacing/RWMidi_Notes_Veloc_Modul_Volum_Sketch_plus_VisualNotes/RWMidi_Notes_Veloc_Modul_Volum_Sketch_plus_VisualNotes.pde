...
String velocityMessage = "(velocity: 127)";
float rotateAngle;
...
void setup(){
    ...
    textFont(font,40); // specify wich font to be used
    ...
    // try a plug
    //input.plug(this, "notOnMyWay"); // here used to display easily the velocity of keyPresse(s)
...
void noteOnReceived(Note note){
    ...
    if (note.getVelocity() == 0){
      ...
      velocityMessage = "(velocity: " + note.getVelocity() +")";
    }
}
